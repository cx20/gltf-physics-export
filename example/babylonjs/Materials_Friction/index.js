...
const MODEL_ROOT = 'https://raw.githubusercontent.com/eoineoineoin/glTF_Physics/master/samples/Materials_Friction/';
const MODEL_FILE = 'Materials_Friction.glb';
...
async function createScene() {
    ...
    if (allMeshes.length > 0) {
        ...
        const radius = BABYLON.Vector3.Distance(bounds.min, bounds.max) * 0.55;
